...
export const metadata = {
  ...
  description: "Ready to transform your business? Contact TrybeNode for custom software development, e-commerce platforms, and automated systems. Located at Leadcity University, Ibadan. Email: info@trybenode.online",
  keywords: "contact TrybeNode, software development consultation, e-commerce development Nigeria, Leadcity University Ibadan, custom software quote, TrybeNode contact",
  openGraph: {
    type: "website",
    locale: "en_NG",
    ...
    description: "Get in touch with TrybeNode for innovative digital solutions. We're based in Ibadan, Nigeria and ready to bring your ideas to life.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Contact TrybeNode - Get Your Free Consultation",
    description: "Ready to build innovative digital solutions? Contact TrybeNode in Ibadan, Nigeria.",
    images: ["https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=1200&q=80"],
  },
};
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-1">Our team is here to help</p>
                    <a href="mailto:contact@trybenode.online" className="text-[#725eed] font-semibold hover:underline text-base">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-1">24/7 Support Available</p>
                    <a href="tel:+2348101502547" className="text-[#725eed] font-semibold hover:underline text-base">
                      +234 810 150 2547
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-1">Our Headquarters</p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              Prefer to Connect on <span className="text-[#725eed]">Social Media?</span>
            </h2>
